...
Configure the in-memory adapter in your environment config file, `config/test.exs`:
...
Then you can use ExUnit's case template feature to restart the in-memory event store for each test run.
