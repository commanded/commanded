defmodule Commanded.Events.Registry do
  use GenServer
  require Logger

  alias Commanded.Events.Registry
  ...
  @spec register(atom, Commanded.Events.Handler) :: :ok
  ...
  """
  @spec handlers(map) :: [Commanded.Events.Handler]
  ...
  Get all registered handlers for the given event
  """
  @spec handlers(atom) :: [Commanded.Events.Handler]
